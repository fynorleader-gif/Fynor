...
# --- CONFIGURATION ---
TOKEN = '8662822210:AAG0QlH6p5o4Ba-sXhw62wpl1fD0o_7RaZQ'
...
async def handle_input(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    # --- STATE LOGIC: DUPLICATE CHECK ---
        ...
        if dups: kb.append([InlineKeyboardButton("Duplicate List", callback_data="do")])
        await update.message.reply_text(report, reply_markup=InlineKeyboardMarkup(kb), parse_mode=ParseMode.MARKDOWN)

    # --- STATE LOGIC: COMMENT LIST CHECK ---
...
def main():
    ...
    app.add_handler(CommandHandler("start", lambda u, c: start_menu(u, c)))
